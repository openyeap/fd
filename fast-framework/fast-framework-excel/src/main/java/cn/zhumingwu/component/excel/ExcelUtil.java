package cn.zhumingwu.component.excel;
...
//                            if (!dict.isEmpty()) {
//                                var dictEle = ApplicationContextHolder.getCacheManager().getCache(dict);
//                                if (dictEle != null) {
//                                    @SuppressWarnings("unchecked") Map<String, String> dictValue = (Map<String, String>) dictEle.get(dict);
