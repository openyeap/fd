 ...
 * 普通JAR包解密器
 */
public class KofferDecryptor extends XEntryDecryptor<JarArchiveEntry>
        implements XDecryptor, XConstants {
    private final int level;

    public KofferDecryptor(XDecryptor xDecryptor) {
        this(xDecryptor, new KofferAllEntryFilter());
    }

    public KofferDecryptor(XDecryptor xDecryptor, XEntryFilter<JarArchiveEntry> filter) {
        this(xDecryptor, Deflater.DEFAULT_COMPRESSION, filter);
    }

    public KofferDecryptor(XDecryptor xDecryptor, int level) {
        this(xDecryptor, level, new KofferAllEntryFilter());
    }

    public KofferDecryptor(XDecryptor xDecryptor, int level, XEntryFilter<JarArchiveEntry> filter) {
