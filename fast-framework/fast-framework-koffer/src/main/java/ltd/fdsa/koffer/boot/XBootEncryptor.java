...
import cn.zhumingwu.koffer.jar.KofferEncryptor;
...
public class XBootEncryptor extends XEntryEncryptor<JarArchiveEntry>
...

    {
        ...
        map.put(jarLauncher, "cn.zhumingwu.koffer.boot.KofferLauncher");
        map.put(warLauncher, "cn.zhumingwu.koffer.boot.XWarLauncher");
        map.put(extLauncher, "cn.zhumingwu.koffer.boot.XExtLauncher");
    }
