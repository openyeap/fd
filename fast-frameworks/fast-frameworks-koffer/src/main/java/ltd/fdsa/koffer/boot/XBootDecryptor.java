...
import cn.zhumingwu.koffer.jar.KofferAllEntryFilter;
import cn.zhumingwu.koffer.jar.KofferDecryptor;
 ...
 * Spring-Boot JAR包解密器
 */
public class XBootDecryptor extends XEntryDecryptor<JarArchiveEntry>
    ...
    public void decrypt(XKey key, InputStream in, OutputStream out) throws IOException {
        ...
        try {
            ...
            KofferDecryptor KofferDecryptor = new KofferDecryptor(xDecryptor, level, filter);
            ...
            while ((entry = zis.getNextJarEntry()) != null) {
                ...
                // BOOT-INF/lib/**
                    ...
                    boolean need = KofferDecryptor.predicate(lib);
                    lib.reset();
                    if (need) {
                        ByteArrayOutputStream bos = new ByteArrayOutputStream();
                        CheckedOutputStream cos = new CheckedOutputStream(bos, new CRC32());
                        KofferDecryptor.decrypt(key, lib, cos);
                        JarArchiveEntry jarArchiveEntry = new JarArchiveEntry(entry.getName());
