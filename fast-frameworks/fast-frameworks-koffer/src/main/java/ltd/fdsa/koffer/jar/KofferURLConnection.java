 ...
 * 加密的URL连接
 */
public class KofferURLConnection extends JarURLConnection {
    ...
    public KofferURLConnection(
            JarURLConnection jarURLConnection, XDecryptor xDecryptor, XEncryptor xEncryptor, XKey xKey)
