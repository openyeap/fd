package ltd.fdsa.devtools.generate.utils;
...
import ltd.fdsa.devtools.generate.template.PomXmlTemplate;
import ltd.fdsa.devtools.generate.utils.parser.JavaParseUtil;
import ltd.fdsa.devtools.generate.utils.parser.XmlParseUtil;
...
public class GenerateUtil {
    ...
    public static String getJavaFilePath(Generate generate, TierType tierType) {
        ...
        // maven模块方式
        if (moduleType.equals(ModuleType.ALONE.getCode()) && Arrays.asList(MODULE_TIER).contains(tierType)) {
