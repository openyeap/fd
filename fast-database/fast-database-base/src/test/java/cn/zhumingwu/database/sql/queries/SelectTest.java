...
import static cn.zhumingwu.database.sql.queries.Queries.selectDistinct;
    ...
    void testBuildComplexSelect() {
        ...
        var select = selectDistinct(FORENAME, LASTNAME, SIZE)
                ...
                .where(FORENAME.isNotEqualTo(LASTNAME)
                        ...
                        .and(subCondition)
                        .and(Condition.nested(AGE.isEqualTo(FORENAME).and(FORENAME.isNotNull()))
                ...
                .groupBy("foreCount")
                .having(Function.sum(AGE).isGreaterThan(20)
