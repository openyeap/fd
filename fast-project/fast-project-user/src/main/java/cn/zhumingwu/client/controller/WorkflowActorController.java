...
@Slf4j
public class WorkflowActorController extends BaseController {
    @Autowired
    private WorkflowActorService service;
    ...
    public Result<Object> insert(@RequestBody WorkflowActor entity) {
        try {
    ...
    public Result<Object> update(@RequestBody WorkflowActor entity) {
        try {
