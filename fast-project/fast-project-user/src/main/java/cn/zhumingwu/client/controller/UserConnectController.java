...
public class UserConnectController extends BaseController {
    @Autowired
    private UserConnectService service;
    ...
    public Result<Object> insert(@RequestBody UserConnect entity) {
        try {
    ...
    public Result<Object> update(@RequestBody UserConnect entity) {
        try {
