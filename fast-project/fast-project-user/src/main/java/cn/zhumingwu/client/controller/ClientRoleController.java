...
@Slf4j
public class ClientRoleController extends BaseController {
    @Autowired
    private ClientRoleService service;
    ...
    public Result<Object> insert(@RequestBody ClientRole entity) {
        try {
    ...
    public Result<Object> update(@RequestBody ClientRole entity) {
        try {
