...
@RestController
@RequestMapping("datasetattribute")
@Slf4j
public class DatasetAttributeController extends BaseController {
    @Autowired
    private DatasetAttributeService service;
    ...
    public Result<Object> insert(@RequestBody DatasetAttribute entity) {
        try {
    ...
    public Result<Object> update(@RequestBody DatasetAttribute entity) {
        try {
