...
public interface DateTimeConditions extends LikeConditions
{
    ...
    {
        return value == null ? new GenericCondition(GenericCondition.GenericConditionType.IS_NULL, this) : new GenericCondition(GenericCondition.GenericConditionType.IS_EQUAL_TO, this, convert(value, getDateConversion()));
    }
    ...
    {
        return value == null ? new GenericCondition(GenericCondition.GenericConditionType.IS_NOT_NULL, this) : new GenericCondition(GenericCondition.GenericConditionType.IS_NOT_EQUAL_TO, this, convert(value, getDateConversion()));
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_GREATER_THAN, this, convert(value, getDateConversion()));
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_GREATER_THAN_OR_EQUAL_TO, this, convert(value, getDateConversion()));
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_LESS_THAN, this, convert(value, getDateConversion()));
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_LESS_THAN_OR_EQUAL_TO, this, convert(value, getDateConversion()));
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_BETWEEN, this, convert(value1, getDateConversion()), convert(value2, getDateConversion()));
    }

    default Condition isBetween(LocalDate value1, Date value2)
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_BETWEEN, this, value1, convert(value2, getDateConversion()));
    }

    default Condition isBetween(Date value1, LocalDate value2)
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_BETWEEN, this, convert(value1, getDateConversion()), value2);
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_BETWEEN, this, convert(value, getDateConversion()), otherColumn);
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_BETWEEN, this, otherColumn, convert(value, getDateConversion()));
    }
    ...
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_BETWEEN, this, convert(value, getDateConversion()), placeholder);
    }

    default Condition isBetween(Placeholder placeholder, Date value)
    {
        return new GenericCondition(GenericCondition.GenericConditionType.IS_BETWEEN, this, placeholder, convert(value, getDateConversion()));
    }
    ...
    public static Temporal convert(Date date, Function<ZonedDateTime, Temporal> convertFunction)
    {
