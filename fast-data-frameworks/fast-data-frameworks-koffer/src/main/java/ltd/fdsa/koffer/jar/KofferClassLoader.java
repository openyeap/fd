...
import ltd.fdsa.koffer.reflection.KReflection;
 ...
 * JAR包类加载器
 */
public class KofferClassLoader extends URLClassLoader {
    static {
        ClassLoader.registerAsParallelCapable();
    }

    private final KofferURLHandler KofferURLHandler;
    ...
    public KofferClassLoader(URL[] urls, ClassLoader parent, XDecryptor decryptor, XEncryptor encryptor, XKey xKey)
            throws Exception {
        super(urls, parent);
        this.KofferURLHandler = new KofferURLHandler(decryptor, encryptor, xKey, this);
    ...
    public URL findResource(String name) {
        ...
        try {
            return new URL(
                    url.getProtocol(), url.getHost(), url.getPort(), url.getFile(), KofferURLHandler);
    ...
    public Enumeration<URL> findResources(String name) throws IOException {
        ...
        return new KofferEnumeration(enumeration);
    }
    ...
    private class KofferEnumeration implements Enumeration<URL> {
        private final Enumeration<URL> enumeration;

        KofferEnumeration(Enumeration<URL> enumeration) {
