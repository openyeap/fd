package cn.zhumingwu.starter.register.properties;
...
@Data
@ConfigurationProperties(prefix = RegisterProperties.PREFIX)
@ToString
public class RegisterProperties {
    public static final String PREFIX = "project.register";
    /**
