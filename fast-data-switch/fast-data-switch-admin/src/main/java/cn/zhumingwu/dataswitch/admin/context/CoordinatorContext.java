...
import cn.zhumingwu.dataswitch.admin.thread.JobLogReporter;
import cn.zhumingwu.dataswitch.admin.thread.JobScheduler;
import cn.zhumingwu.dataswitch.admin.service.impl.ExecutorClientImpl;
import cn.zhumingwu.dataswitch.admin.thread.JobFailMonitor;
import cn.zhumingwu.dataswitch.admin.thread.JobTrigger;
...
@Component
@Slf4j
public class CoordinatorContext implements ApplicationListener<ServiceDiscoveredEvent>, SmartLifecycle {
