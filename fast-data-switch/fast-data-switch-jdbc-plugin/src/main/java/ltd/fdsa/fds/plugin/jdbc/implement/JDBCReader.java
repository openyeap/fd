...
//
//public class JDBCReader extends DataSource  {
// private static final String JDBC_READER_SQL_METRIC_TIME_MS ="jdbc.reader.metric.time.ms"; 
...
//    @Override
//    public void prepare(JobContext context, ReaderConfig readerConfig) {
//        sqlMetricTime = context.getEngineConfig().getLong(JDBC_READER_SQL_METRIC_TIME_MS, -1);
...
//                }
//            } else {
//                throw new FastDataSwitchException("sql 分片 为空");
//            }
//
//            statement.close();
