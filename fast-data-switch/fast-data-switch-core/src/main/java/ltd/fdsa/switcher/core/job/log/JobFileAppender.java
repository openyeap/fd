...
public class JobFileAppender {
    ...
    private static String logBasePath = "/logs/job/handler";
    ...
    /**
     * log filename, like "logBasePath/yyyy-MM-dd/996.log"
     *
     * @param triggerDate
     * @param logId
     * @return
    ...
    public static String makeLogFileName(Date triggerDate, long logId) {
        ...
        // logBasePath/yyyy-MM-dd/996.log
        String logFileName =
                logFilePath.getPath().concat(File.separator).concat(String.valueOf(logId)).concat(".log");
        return logFileName;
    }
