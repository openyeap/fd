...
public final class Serializers implements Serializable {
     ...
     * @throws IOException if an io error occurs
     */
    public static void serialize(DataOutput out, Serializers serializers)
            throws IOException {
     ...
     * @throws ClassNotFoundException if a class error occurs
     */
    public static void deserialize(DataInput in, Serializers serializers)
            throws IOException, ClassNotFoundException {
        int size = in.readInt();
        if (size > 0) {
     ...
     * @return serializer
     */
    public Serializer getSerializer(int index) {
