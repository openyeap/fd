package cn.zhumingwu.dataswitch.jdbc;
...
public class JdbcUtils {
    ...
    public static Map<String, Integer> getColumnTypes(
            Connection connection, String table, String keywordEscaper) throws SQLException {
        ...
        ResultSetHandler<Map<String, Integer>> handler =
     ...
     * @throws SQLException
     */
    public static List<String> getColumnNames(Connection conn, String table, String keywordEscaper)
            throws SQLException {
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT * FROM ");
        sql.append(keywordEscaper);
        ...
        ResultSetHandler<List<String>> handler =
     ...
     * @throws SQLException
     */
    public static double[] querySplitColumnRange(
            Connection conn, final String sql, final String splitColumn) throws SQLException {
        ...
        if (m.find() && splitColumn != null && !splitColumn.trim().isEmpty()) {
            ...
            ResultSetHandler<double[]> handler =
     ...
     * @throws SQLException
     */
    public static String getDigitalPrimaryKey(
            Connection conn, String catalog, String schema, String table, String keywordEscaper)
            throws SQLException {
